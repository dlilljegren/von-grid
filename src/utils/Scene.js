...
import * as THREEX from '../../lib/OrbitControls.js';
/*
...
export class Scene{
	constructor(sceneConfig, controlConfig) {
		...
		const sceneSettings = Tools.merge(defaultSceneSettings, sceneConfig);
		...
		if (this.contolled) {
			this.controls = new THREEX.OrbitControls(this.camera, this.renderer.domElement);
